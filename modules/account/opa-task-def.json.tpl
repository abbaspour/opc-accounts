[
  {
    ...
    "entryPoint" : [
        ...
        "--set", "bundles.default.service=s3",
        "--set", "bundles.default.resource=/${account_no}/bundle.tar.gz",
        "--set", "bundles.default.persist=false",
        "--set", "bundles.default.polling.min_delay_seconds=600",
        "--set", "bundles.default.polling.max_delay_seconds=1200",
